...
Pre-built packages are recommended for most users as the app uses some Google Play Services, which are more likely to be ready on your device when you install from the Play Store.
...
Welcome to Yantra Launcher! You may see your wallpaper replaced by a solid black terminal background, with some text and a blinking cursor waiting below it. The exact starting view depends on your device and launcher settings.
